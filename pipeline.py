...
LUA_SHA1 = get_hash(os.path.join(CWD, 'chrome-web-store.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            '--no-cookies',
            '--content-on-error',
            '--lua-script', 'chrome-web-store.lua',
            ...
            '--warc-header', 'chrome-web-store-script-version: ' + VERSION,
            '--warc-header', ItemInterpolation('chrome-web-store-item: %(item_name)s'),
